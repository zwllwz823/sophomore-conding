...
public:
    ...
    bool addBalance (const string &uname,double b);
    bool redBalance (const string &uname, double b);
    string getOwner(const std::string& name);
    
    bool buy(const string &uname);
    bool clearCart(const string &uname);
    bool addCart(const string &uname,const string &name,int q);
    bool redCart(const string& uname, const string& name, int q);
    //bool delCart(const string& uname, const string& name);
